...
public class FileSortHelper {
    ...
    private Comparator cmpSize = new FileComparator() {
        @Override
        public int doCompare(FileInfo object1, FileInfo object2) {
            return longToCompareInt(new File(object1.filePath).length() - new File(object2.filePath).length());
        }
    };
    ...
    private Comparator cmpDate = new FileComparator() {
        @Override
        public int doCompare(FileInfo object1, FileInfo object2) {
            return longToCompareInt(new File(object2.filePath).lastModified() - new File(object1.filePath).lastModified());
        }
    };
